...
class Fragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val buttonShuffle = view.findViewById(R.id.button_shuffle) as Button
        val buttonClockwise = view.findViewById(R.id.button_clockwise) as Button
        val buttonHide = view.findViewById(R.id.button_hide) as Button
        val buttonRestore = view.findViewById(R.id.button_restore) as Button
